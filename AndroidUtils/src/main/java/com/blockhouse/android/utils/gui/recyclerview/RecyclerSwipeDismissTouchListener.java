 ...
 */
public class RecyclerSwipeDismissTouchListener implements View.OnTouchListener {
     ...
     */
    public RecyclerSwipeDismissTouchListener(RecyclerView recyclerView, DismissCallbacks callbacks) {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    for (PendingDismissData pendingDismiss : mPendingDismisses) {
                        ...
                        //Removed to avoid double animation blip.
